...
BANNING_ML_MUTATION = "For the mutation to a novel hypothesis, please do not use any ML related concepts as the novel component of the new mutation. The reason is that currently we are using a ML related example in the prompt to explain how to obtain the hypothesis from the research background and the inspirations, and it seems that as a result ML related concepts are overused in the mutation generation. "
